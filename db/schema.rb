...
ActiveRecord::Schema[8.0].define(version: 2025_03_19_125713) do
  ...
  create_table "error_reports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "error_message", array: true
    t.text "errors_list"
    t.text "row_data"
    t.integer "line", default: 0
    t.index ["imported_file_id"], name: "index_error_reports_on_imported_file_id"
  end
  ...
  create_table "imported_files", force: :cascade do |t|
    ...
    t.integer "company_profile_created"
    t.integer "job_posting_created"
    t.integer "error_count"
    t.integer "lines_total", default: 0
    t.integer "status", default: 0
  ...
  add_foreign_key "error_reports", "imported_files"
